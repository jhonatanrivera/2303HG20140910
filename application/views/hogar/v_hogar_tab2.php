...
<table class="table table-bordered" id="table3">
	...
	<tbody>
		<tr id="tr10-1"><td class="hgCenter"><label for="S1_B_10-1">1</label></td><td><input type="text" class="form-control rDig1-2 setFlujo" id="S1_B_10-1" name="S1_B_10[1]" maxlength="1" onchange="setFlujo(this,2,2)" /></td><td><input type="text" class="form-control" id="S1_B_11-1" name="S1_B_11[1]"/></td><td><input type="text" class="form-control rDig1-2 setFlujo" id="S1_B_12-1" name="S1_B_12[1]" maxlength="1" onchange="setFlujo(this,1,2)" /></td><td><input type="text" class="form-control wd-inner-30 rDig1-12 passTD" id="S1_B_13-1" name="S1_B_13[1]" maxlength="2" onchange="especificar(this,12)"/><input type="text" class="form-control wd-inner-70 rA spec" id="S1_B_13_O-1" name="S1_B_13_O[1]" placeholder="Especifique" disabled="disabled"/></td><td><input type="text" class="form-control rDig1-2 setFlujo" id="S1_B_14-1" name="S1_B_14[1]" maxlength="1" onchange="setFlujo(this,2,4)" /></td><td><input type="text" class="form-control rDig1-6" id="S1_B_15_N-1" name="S1_B_15_N[1]" maxlength="1"/></td><td><input type="text" class="form-control rDig1-8" id="S1_B_15_AG-1" name="S1_B_15_AG[1]" maxlength="1"/></td><td><input type="text" class="form-control wd-inner-30 rDig1-5 passTD" id="S1_B_16-1" name="S1_B_16[1]" maxlength="1" onchange="especificar(this,5)"/><input type="text" class="form-control wd-inner-70 rA spec" id="S1_B_16_O-1" name="S1_B_16_O[1]" placeholder="Especifique" disabled="disabled"/></td></tr>
	</tbody>
...
<table class="table table-bordered" id="table10">
	...
	<tbody>
		<tr id="tr34-1"><td class="hgCenter"><label for="S1_E_34-1">1</label></td><td><input type="text" class="form-control rDig1-2 setFlujo" id="S1_E_34-1" name="S1_E_34[1]" maxlength="1" onchange="setFlujo(this,1,3)" /></td><td><input type="text" class="form-control rDig1-5 setFlujo" id="S1_E_35-1" name="S1_E_35[1]" maxlength="1" onchange="set35(this,1)"/></td><td><input type="text" class="form-control wd-inner-30 rDig1-7 setFlujo" id="S1_E_36-1" name="S1_E_36[1]" maxlength="1" onchange="set36(this,1)"/><input type="text" class="form-control wd-inner-70 rA spec" id="S1_E_36_O-1" name="S1_E_36_O[1]" placeholder="Especifique" disabled="disabled"/></td><td><input type="text" class="form-control rA rNotReq" id="S1_E_37-1" name="S1_E_37[1]"/></td><td><input type="text" class="form-control rA" id="S1_E_38-1" name="S1_E_38[1]"/></td></tr>
	</tbody>
</table>
<br><br>
<table class="table table-bordered" id="table11">
	...
	<tbody>
		<tr id="tr39-1"><td class="hgCenter"><label for="S1_E_39-1">1</label></td><td><input type="text" class="form-control wd-inner-30 rDig1-7 setFlujo" id="S1_E_39-1" name="S1_E_39[1]" maxlength="1" onchange="set39(this,1)"/><input type="text" class="form-control wd-inner-70 rA spec" id="S1_E_39_O-1" name="S1_E_39_O[1]" placeholder="Especifique" disabled="disabled"/></td><td><input type="text" class="form-control wd-inner-30 rDig1-6 passTD" id="S1_E_40-1" name="S1_E_40[1]" maxlength="1" onchange="especificar(this,6)"/><input type="text" class="form-control wd-inner-70 rA spec" id="S1_E_40_O-1" name="S1_E_40_O[1]" placeholder="Especifique" disabled="disabled"/></td><td><input type="text" class="form-control rDig1-2 setFlujo" id="S1_E_41-1" name="S1_E_41[1]" maxlength="1" onchange="set41(this,1)" /></td><td><input type="text" class="form-control rA" id="S1_E_42-1" name="S1_E_42[1]"/></td><td><input type="text" class="form-control rA" id="S1_E_43-1" name="S1_E_43[1]"/></td><td><input type="text" class="form-control wd-inner-30 rDig1-7 passTD" id="S1_E_44-1" name="S1_E_44[1]" maxlength="1" onchange="especificar(this,7)"/><input type="text" class="form-control wd-inner-70 rA spec" id="S1_E_44_O-1" name="S1_E_44_O[1]" placeholder="Especifique" disabled="disabled"/></td></tr>
	</tbody>
</table>
<br><br>
<table class="table table-bordered" id="table12">
	...
	<tbody>
		<tr id="tr45-1"><td class="hgCenter"><label for="S1_E_45-1">1</label></td><td><input type="text" class="form-control wd-inner-30 rDig1-7 passTD" id="S1_E_45-1" name="S1_E_45[1]" maxlength="1" onchange="especificar(this,[1,6])"/><input type="text" class="form-control wd-inner-70 rN spec" id="S1_E_45_Esp-1" name="S1_E_45_Esp[1]" placeholder="Especifique" disabled="disabled"/></td><td><input type="text" class="form-control wd-inner-30 rDig1-7 passTD" id="S1_E_46-1" name="S1_E_46[1]" maxlength="1" onchange="especificar(this,[1,6])"/><input type="text" class="form-control wd-inner-70 rN spec" id="S1_E_46_Esp-1" name="S1_E_46_Esp[1]" placeholder="Especifique" disabled="disabled"/></td><td><input type="text" class="form-control wd-inner-30 rDig1-6 passTD" id="S1_E_47-1" name="S1_E_47[1]" maxlength="1" onchange="especificar(this,[1,6])"/><input type="text" class="form-control wd-inner-70 rN spec" id="S1_E_47_Esp-1" name="S1_E_47_Esp[1]" placeholder="Especifique" disabled="disabled"/></td></tr>
	</tbody>
</table>
<br>
<table class="table table-bordered">
